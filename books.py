...
BOOKS = [
    Book(1, 'Computer Science Pro', 'codingwithali', 'A very nice book!', 5, 2030),
    Book(2, 'Be Fast with FastAPI', 'codingwithali', 'A great book!', 5, 2030),
    Book(3, 'Master Endpoints', 'codingwithali', 'A awesome book!', 5, 2029),
